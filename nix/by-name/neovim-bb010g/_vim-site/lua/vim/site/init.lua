...
local vim_site_module, vim_site_is_submodule = vim.site, vim._submodules.site
if vim_site_module == nil then vim_site_module = {} end
-- These are for loading runtime modules in the vim.site namespace lazily.
local vim_site_submodules = vim_site_module._submodules
if vim_site_submodules == nil then vim_site_submodules = {}; vim_site_module._submodules = vim_site_submodules end
local vim_site_module_mt = getmetatable(vim_site_module)
if vim_site_module_mt == nil then vim_site_module_mt = {} end
--- @param t table<any,any>
function vim_site_module_mt.__index = function(t, key)
